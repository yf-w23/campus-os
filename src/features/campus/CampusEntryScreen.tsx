...
const styles = StyleSheet.create({
  ...
  heroIcon: {width: 52, height: 52, resizeMode: 'contain'},
  ...
  entrySubtitle: {...typography.caption, color: colors.textSecondary, marginTop: 2},
  ...
  overlayText: {...typography.body, color: '#fff'},
});
