...
下载 `campus-os-v1.1.0-android-arm64.apk`（约 32 MB），传到 Android 手机安装即可。
...
- **工具调用（Function Calling）**：
  ...
  - **需确认**（中等风险）：预约图书馆座位/研读间、电费充值、校园卡充值、注销校园网设备、添加/删除个人备忘、选课
...
| 工具生态 | AI 工具扩展至 42 个，覆盖课表/成绩/作业/教室/电费/校园卡/校园网/图书馆/备忘/选课链路 |
